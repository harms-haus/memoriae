...
- run `cd /user/blake/Documents/software/memoriae; npm run a --uv` and resolve any test failures. Use the design or plan as the ground-truth, not the code or tests. Continue resolving test failures and build errors until the build errors and tests failures are completely resolved.
