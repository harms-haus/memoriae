...
describe("Timeline", () => {
  ...
  describe("Rendering", () => {
    ...
    it("should render nothing for empty items array", () => {
      const { container } = render(
        <Timeline items={[]} mode="center" renderPanel={() => null} />,
      );
  ...
  describe("Timeline Lines", () => {
    it("should not render top line for first item", () => {
      ...
      expect(topLine).toHaveClass("timeline-line-top-invisible");
    });
    ...
    it("should not render bottom line for last item", () => {
      ...
      expect(bottomLine).toHaveClass("timeline-line-bottom-invisible");
    });
  ...
  describe("Custom Rendering", () => {
    it("should call renderPanel with correct index and width", () => {
      ...
      render(
        <Timeline items={items} mode="center" renderPanel={renderPanel} />,
      );
    ...
    it("should call createPanel when provided", () => {
      ...
      render(
        <Timeline items={items} mode="center" createPanel={createPanel} />,
      );
  ...
  describe("Edge Cases", () => {
    ...
    it("should handle two items", () => {
      ...
      expect(firstItem).toBeTruthy();
      expect(
        firstItem?.querySelector(".timeline-line-top"),
      ).toBeInTheDocument();
      expect(firstItem?.querySelector(".timeline-line-top")).toHaveClass(
        "timeline-line-top-invisible",
      );
      expect(
        firstItem?.querySelector(".timeline-line-bottom"),
      ).toBeInTheDocument();
      ...
      expect(secondItem).toBeTruthy();
      expect(
        secondItem?.querySelector(".timeline-line-top"),
      ).toBeInTheDocument();
      expect(secondItem?.querySelector(".timeline-line-top")).not.toHaveClass(
        "timeline-line-top-invisible",
      );
      expect(
        secondItem?.querySelector(".timeline-line-bottom"),
      ).toBeInTheDocument();
      expect(secondItem?.querySelector(".timeline-line-bottom")).toHaveClass(
  ...
  describe("Custom Renderers", () => {
    it("should use custom renderPanel function", () => {
      ...
      render(<Timeline items={items} mode="left" renderPanel={renderPanel} />);
    ...
    it("should use custom createPanel function", () => {
      ...
      render(<Timeline items={items} mode="left" createPanel={createPanel} />);
    ...
    it("should use custom renderDot function", () => {
      ...
      expect(renderDot).toHaveBeenCalledTimes(3);
      expect(renderDot).toHaveBeenCalledWith(
        0,
        expect.any(Number),
        true,
        false,
  ...
  describe("renderOpposite", () => {
    ...
    it("should receive correct panelSide parameter", () => {
      ...
      expect(renderOpposite).toHaveBeenCalledWith(
        0,
        expect.any(Number),
        "right",
      );
  ...
  describe("Edge Cases", () => {
    it("should handle single item (no lines)", () => {
      ...
      // Should have invisible lines for single item
