...
export default defineConfig({
  ...
  /* Use separate workers to prevent bundling all test files together */
  workers: 1, // Use 1 worker to ensure tests run sequentially and modules aren't bundled together
